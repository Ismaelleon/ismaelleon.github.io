...
function toggleMenu() {
    document.querySelector('nav').classList.toggle('max-sm:inset-x-full');
    document.querySelector('nav').classList.toggle('max-sm:inset-x-0');
    document.querySelector('nav > i').classList.toggle('max-sm:scale-100');
}
